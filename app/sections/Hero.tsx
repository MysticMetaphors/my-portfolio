...
export default function Hero() {
  return (
    <section className="relative flex flex-col inset-shadow- items-center justify-center min-h-screen text-center overflow-hidden md:pt-0 pt-25 bg-black">
      {/* <div className="absolute inset-0 z-10 bg-[radial-gradient(circle_at_center,rgba(0,255,153,0.08)_0%,transparent_70%)] pointer-events-none"></div> */}
      <div className="absolute inset-0 z-10 bg-[linear-gradient(to_bottom,rgba(0,0,0,0)_0%,rgb(3,9,12)_100%)] pointer-events-none"></div>
      {/* <div className="absolute inset-0 z-10 opacity-10 bg-[url('data:image/svg+xml,<svg xmlns=\\'http://www.w3.org/2000/svg\\' width=\\'100\\' height=\\'100\\'><rect width=\\'100\\' height=\\'100\\' fill=\\'none\\' stroke=\\'%2300FF99\\' stroke-width=\\'0.5\\'/></svg>')]"></div> */}
      ...
      <GlobeBG>
        <div className="flex flex-col items-center justify-center min-h-screen w-screen px-6 sm:p-0">
          ...
          >
            ...
            <h1 className="relative text-5xl md:text-6xl font-extrabold tracking-tight text-white leading-tight">
